...
public class KeranjangModel implements Serializable {
    ...
    public KeranjangModel(String productName, String productPrice, String currentDate, String currentTime, String totalQuantity, int totalPrice) {
    ...
    public KeranjangModel(String doucmentId) {
